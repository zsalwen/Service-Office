		...
		foreach($serverList as $k1 => $v1){
			...
			foreach ($v1 as $k2 => $v2){
				...
				foreach ($v2 as $k3 => $v3){
					...
					<div style='background-color:green; border: 1px solid black;' onclick='hideshow($k1-$k2-$k3);'>$$k3 SERVES</div>
					<table style='display:none; border: 1px solid black; border-collapse:collapse;' border='1' align='center' id='$k1-$k2-$k3'>
	...
	if (isset($serverList)){
		...
		foreach($serverList as $k1 => $v1){
			...
			foreach($v1 as $k2 => $v2){
				...
				<div style='background-color:green; border: 1px solid black;' onclick='hideshow($k1-$k2);'>$$k2 SERVES</div>
				<table style='display:none; border: 1px solid black; border-collapse:collapse;' border='1' id='$k1-$k2'>
