...
if ($_POST[submit]){
	@mysql_query("INSERT INTO market (type, name, contact, phone, address, createDate, createID) VALUES ('$_POST[type]','$_POST[name]','$_POST[contact]','$_POST[phone]', $_POST[address], NOW(), '".$_COOKIE[psdata][user_id]."')");
