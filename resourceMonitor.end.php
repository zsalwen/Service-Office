...
resourceMonitorStartServerResponse($_SERVER["SCRIPT_FILENAME"],number_format($totaltimeResourceMonitorStart,10),$_SERVER["QUERY_STRING"],$logResourceMonitorStart,$_GET[debug]);
}
?>