...
$q="select * from ps_packets, ps_pay where ps_packets.packet_id = '$_GET[packet]' AND ps_packets.packet_id=ps_pay.packetID AND ps_pay.product='OTD'";
$r=@mysql_query($q);
$d=mysql_fetch_array($r,MYSQL_ASSOC);

$q2 = "SELECT attorneys.address, ps_packets.attorneys_id FROM ps_packets, attorneys WHERE ps_packets.attorneys_id = attorneys.attorneys_id AND packet_id = '$_GET[packet]'";
$r2=@mysql_query($q2);
...
<h2 align="center">Internal Service Account For Packet <?=$_GET[packet]?></h2>
...
<table cellspacing="0" cellpadding="3" width="768px" align="center">
	<tr>
		<td valign="top"><center><div style="font-size:10px;text-align:left;"><b>Order History</b><br><?=$d[timeline]?></div><center></td>
	 <td valign="top" style="font-size:10px;text-align:left;"><b>Service Data</b><br>
	 ...
	 <center><div style="font-size:10px;text-align:left;"><b>Case Documents</b><br><?
