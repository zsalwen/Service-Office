...
$r2=@mysql_query("select * from occNotices where clientFile = '$d[client_file]'");
...
$header="<td colspan='2' align='center' style='font-size:20px;'>CIRCUIT COURT OF $court, MARYLAND</td></tr>
		<tr></tr>
		<tr><td class='a' width='500px'>$plaintiff<br><small>_________________________<br /><em>Plaintiff</em></small><br /><br />v.<br /><br />";
			...
			$header .= "<small>_________________________<br /><em>Defendant</em></small></td>
				<td align='right' valign='top' style='padding-left:100px; width:100px;' nowrap='nowrap'><div style='font-size:24px; border:solid 1px #666666; text-align:center;'>Case Number<br />".str_replace(0,'&Oslash;',$d[case_no])."</div>";
$cord="EV".$d[eviction_id]."-OCC-".$d2[mailerID]."%";
...
<td colspan="2" style="text-indent:40px">I hereby certify in compliance with 7-105.9(d) "WRITTEN NOTICE ADDRESSED TO 'ALL OCCUPANTS'" that I mailed to the occupant, in compliance with 7-105.9(d)(2)(iii)
