...
</td><td align="center"><div style="font-size:30pt" ><?=$hours?> Hours<div><div style="font-size:15pt" ><?=$days?> Days || <span style='background-color:<?=colorCode2($estHours)?>'>Serve Due: <?=$estFileDate?></span><div></td></tr></table>
</div>
