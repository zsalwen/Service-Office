...
$i=0;
$used = 0;
$q="SELECT id, company, name, last_login, manager_review, DATE_FORMAT(last_login,'%a, %b %D %Y at %r') as login FROM ps_users where level <> 'Administrator' and level <> 'DELETED' and contract = 'YES' ORDER BY name";
