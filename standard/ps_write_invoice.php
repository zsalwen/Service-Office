...
$id=$_GET[id];
$q = "SELECT * FROM standard_packets, attorneys WHERE standard_packets.attorneys_id = attorneys.attorneys_id AND standard_packets.packet_id = '$id'";
...
$pdf->addTextWrap(305,618,300,14,'Server Packet: #S-'.$data['packet_id']);								
