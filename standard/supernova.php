...
$packet = $_GET[packet];
if ($_POST[uspsVerify]){
	@mysql_query("UPDATE standard_packets set uspsVerify = '".$_COOKIE[psdata][name]."' where packet_id = '$_GET[packet]'");
...
$r=@mysql_query("SELECT * FROM standard_packets where packet_id = '$packet' ");
