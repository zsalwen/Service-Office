...
// the is the all files line
		...
		$r=mysql_query("SELECT id FROM packet WHERE date_received LIKE '%$year-$i2%' AND product_id <> '1' AND product_id <> '2' AND product_id <> '8' ");
...
echo "</tr></table>";*/
$src="http://1.chart.apis.google.com/chart?cht=lc&chs=1000x400&chd=t:".$src."|".$burson."|".$white."|".$bgw."|".$other."&chxl=0:".$src2."|1:|0|$z1|$z2|$z3|$z4|$z&chtt=Service Files by Product over Time 2008-$curYear&chdl=All Files|Burson|White|BGW|Others&chco=FF0000,00FF00,0000FF,800080,FF8040&chls=1,1,0|1,1,0|1,1,0|1,1,0|1,1,0";
       ...
       <?=$js?>
        ...
        new google.visualization.LineChart(document.getElementById('visualization')).
            draw(data, {curveType: "function",
                        width: 1600, height: 1024, backgroundColor: '#FFFFFF',
                        vAxis: {maxValue: <?=$z?>}, title: 'Service Files by Product over Time: 2008-<?=$curYear?>',
