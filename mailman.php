...
function getPacketData($packet){
	...
	if ($packet >= 12435 && $d[lossMit] != "N/A - OLD L" && $d[attorneys_id] != 70){
		$data .= "<li><a href='http://staff.mdwestserve.com/otd/stuffPacket.2.php?packet=$packet' target='_blank'><span style='color:green; background-color:black; font-weight:bold;'>Open Envelope GREEN Stuffings</span></a></li>";
