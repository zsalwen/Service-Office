...
function getPacketData($packet){
	...
	if ($packet >= 12435 && $d[lossMit] != "N/A - OLD L" && $d[attorneys_id] != 70){
		$data .= "<li><a href='http://staff.mdwestserve.com/otd/stuffPacket.php?packet=$packet&openDoc=1' target='_blank'>Open Envelope Stuffings</a></li>";
	}elseif($packet >= 12435 && $d[lossMit] != "N/A - OLD L" && $d[attorneys_id] == 70){
		$data .= "<li><a href='http://staff.mdwestserve.com/otd/stuffPacket.bgw.php?packet=$packet&mail=1' target='_blank'>Open Envelope Stuffings</a></li>";
	}
