...
?>
	<tr style="background-color:<? if( $d[filing_status]=="REOPENED"){ echo "#FF8866";}else{ echo rowBgColor($i);}?>;">
		...
		<td><? if ($d[reopenDate] == "0000-00-00"){ echo benchMark2($d[date_received],$start);}else{echo benchMark2($d[reopenDate],$start);}?></td>
...
?>
	<tr style="background-color:<? if( $d2[filing_status]=="REOPENED"){ echo "#FF8866";}else{ echo rowBgColor($i);}?>;">
		...
		<td><? if ($d2[reopenDate] == "0000-00-00"){ echo benchMark2($d2[date_received],$start);}else{echo benchMark2($d2[reopenDate],$start);}?></td>
		<td><?=benchmark($start,$end);?></td>
	</tr>
<? } $count2= $i2; ?>
...
?>
	<tr style="background-color:<? if( $d3[filing_status]=="REOPENED"){ echo "#FF8866";}else{ echo rowBgColor($i);}?>;">
		...
		<td><? if ($d3[reopenDate] == "0000-00-00"){ echo benchMark2($d3[date_received],$start);}else{echo benchMark2($d3[reopenDate],$start);}?></td>
		<td><?=benchmark($start,$end);?></td>
	</tr>
<? } $count3= $i3; ?>
