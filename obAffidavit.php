		...
		$delivery = attorneyCustomLang($d1[attorneys_id],$delivery);
			if ($type == "non"){
				...
				if ($iIDe){
					...
					?>
						<table style='border-collapse:collapse; page-break-after:always; padding:0px;' cellpadding="0" cellspacing="0" width="900px" align="center" bgcolor="#FFFFFF" <? if (strtoupper($d1[affidavit_status]) != "SERVICE CONFIRMED"){ echo $dim;}?>>
				...
				if ($iIDd){
					...
					if (!$d5){
						...
						$historyd = "<u>Describe with particularity the good faith efforts to serve the mortgagor or grantor, ".$d1["name$def"].",  by personal delivery:<br>I, $serverName, made the following efforts:</u>
								<b>".$attemptsd."</b>";
					$cord=$d1[packet_id]."-".$def."-".$serverID."%"; ?>
					<table style='border-collapse:collapse; page-break-after:always; padding:0px;' cellpadding="0" cellspacing="0" width="900px" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF" <? if (strtoupper($d1[affidavit_status]) != "SERVICE CONFIRMED"){echo $dim;}?>>
						<?=str_replace('[CORD]',$cord,$header); ?>
						<tr cellpadding='0' cellspacing='0'>
				...
				<table style='border-collapse:collapse; border-collapse:collapse; page-break-after:always; padding:0px;' cellpadding="0" cellspacing="0" width="900px" align="center" bgcolor="#FFFFFF" <? if (strtoupper($d1[affidavit_status]) != "SERVICE CONFIRMED"){echo $dim;}?>>
					<?=str_replace('[CORD]',$cord,$header); ?>
					<tr cellpadding='0' cellspacing='0'>
