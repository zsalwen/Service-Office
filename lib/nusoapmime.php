<?php
/*
$Id: nusoapmime.php,v 1.1 2009/10/30 14:33:49 patrick Exp $
...
* @version  $Id: nusoapmime.php,v 1.1 2009/10/30 14:33:49 patrick Exp $
* @access   public
*/
		...
		if (strstr($headers['content-type'], 'multipart/related')) {
			...
			foreach ($structure->parts as $part) {
				if (!isset($part->disposition) && (strstr($part->headers['content-type'], 'text/xml'))) {
					$this->debug('Have  part of type ' . $part->headers['content-type']);
					$ = $part->body;
			...
			$this->setError('No  part found in multipart/related content');
			return '';
		}
