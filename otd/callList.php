...
<?
echo "<table align='center' border='1' style='border-collapse:collapse;'><tr><td align='center' colspan='4' style='font-size:16px;'>OUT OF STATE SERVER CALL LIST</td><td align='center'><a href='?all=1'>ALL</a></td><td align='center'><a href='?needCall=1'>NEED CALL</a></td></tr>
...
while ($d=mysql_fetch_array($r,MYSQL_ASSOC)){$i++;
	...
	//if ($oosList != ''){
		...
		if ($d[affidavit_status] == 'ASSIGNED'){
			$status='ACTIVE';
			$color='green';
		}else{
			$status='BLACKHOLE';
