...
echo "<table align='center'><tr><td align='center' colspan='3' style='font-size:16px;'>OUT OF STATE SERVER CALL LIST</td></tr><td>Packet #</td><td>Dispatch Date</td><td><td>Servers to Call</td>";
...
while ($d=mysql_fetch_array($r,MYSQL_ASSOC)){
	echo "<tr><td>$d[packet_id]</td><td>$d[dispatchDate]</td><td>".oosList($d[packet_id])."</td></tr>";
}
echo "</table>";
?>