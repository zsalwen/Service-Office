...
$header="<td class='a' width='49%'>$plaintiff<br><small>_________________________<br /><em>Substitute Trustees<br>Plaintiff(s)</em></small><br /><br />v.<br /><br />";
			...
			$header .= "<small>_________________________<br /><em>Defendant(s)</em></small></td><td style='width:10px;'>*<br>*<br>*<br>*<br>*<br>*<br>*<br>*<br>*<br>*<br>*<br>*<br>*<br>*</td>
				<td  width='49%' align='right' valign='top' nowrap='nowrap'><div style='font-size:16px; font-weight:bold;'>IN THE<BR>CIRCUIT COURT<BR>FOR<BR>$court<BR><BR>Case N&ordm; ".str_replace(0,'&Oslash;',$d[case_no])."</div>";
...
<tr><td colspan="3" align='justify'>*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*nbsp;*</td></tr>
