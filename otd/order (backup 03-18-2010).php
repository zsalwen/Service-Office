...
@mysql_query("UPDATE ps_packets SET name1='$_POST[name1]',
...
@mysql_query("UPDATE ps_packets SET name2='$_POST[name2]',
...
@mysql_query("UPDATE ps_packets SET name3='$_POST[name3]',
...
@mysql_query("UPDATE ps_packets SET name4='$_POST[name4]',
...
@mysql_query("UPDATE ps_packets SET name5='$_POST[name5]',
...
@mysql_query("UPDATE ps_packets SET name6='$_POST[name6]',
