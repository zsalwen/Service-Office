...
<? if($d[address1]){
	...
	if (checkVerify($add) !== true){
		...
		echo "<div style='height:100px; width:300px; border: 1px solid black; background-color:green; font-size:24px; text-align:center; line-height:8em; color:CCFF00;'>VERIFIED</div>";
	}
}
foreach(range('a','e') as $letter){
