...
<table align='center'>
	...
	<? }else{ ?>
		<td align='center'><a href='http://service.mdwestserve.com/stuffPacket.php?packet=<?=$OTD?>' target='_blank'>Server Envelope Stuffings</a> | <a href='http://staff.mdwestserve.com/otd/stuffPacket.php?packet=<?=$OTD?>' target='_blank'>Our Envelope Stuffings</a></td>
	<? } ?>
	</tr>
	<? if ($d2[packet_id]){ ?>
	<tr>
