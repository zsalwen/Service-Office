        ...
        <td nowrap="nowrap"><? 
			...
			foreach (range('a','e') as $letter){
				if ($d["address1$letter"]){
					$list .= "<a target='_Blank' href='http://staff.mdwestserve.com/dispatcher.php?aptsut=&address=".$d["address1$letter"]."&city=".$d["city1$letter"]."&state=".$d["state1$letter"]."&miles=20' title='".$d["address1$letter"].", <a target='_blank' href='staff.mdwestserve.com/contractor_history.php?city=".$d["city1$letter"]."&zip=".$d["zip1$letter"]."'>".$d["city1$letter"]."</a>, ".$d["state1$letter"]." ".$d["zip1$letter"]."'><img src='http://staff.mdwestserve.com/small-usps-logo.jpg' border='0'></a>Service: ".$d["address1$letter"].", <a title='Click to Search For Previous Contractor Rates' target='_blank' href='staff.mdwestserve.com/contractor_history.php?city=".$d["city1$letter"]."&zip=".$d["zip1$letter"]."'>".$d["city1$letter"]."</a>, ".$d["state1$letter"]." <a title='Click to Search For Previous Contractor Rates' target='_blank' href='staff.mdwestserve.com/contractor_history.php?zip=".$d["zip1$letter"]."'>".$d["zip1$letter"]."</a> <b>[".getCounty($d["zip1$letter"])."]</b>".bwaRate($d["zip1$letter"])."<br>";
				}
			}
			if ($list == '' || $d[attorneys_id] == 1){
				$list .= "<a target='_Blank' href='http://staff.mdwestserve.com/dispatcher.php?aptsut=&address=$d[address1]&city=$d[city1]&state=$d[state1]&miles=20' title='$d[address1], $d[city1], $d[state1], $d[zip1]'><img src='http://staff.mdwestserve.com/small-usps-logo.jpg' border='0'></a>Serve &amp; Post: $d[address1], <a title='Click to Search For Previous Contractor Rates' target='_blank' href='staff.mdwestserve.com/contractor_history.php?city=$d[city1]&zip=$d[zip1]'>$d[city1]</a>, $d[state1] <a title='Click to Search For Previous Contractor Rates' target='_blank' href='staff.mdwestserve.com/contractor_history.php?zip=$d[zip1]'>$d[zip1]</a> <b>[".getCounty($d[zip1])."]</b>".bwaRate($d[zip1]);
			}else{
				$list .= "<a target='_Blank' href='http://staff.mdwestserve.com/dispatcher.php?aptsut=&address=$d[address1]&city=$d[city1]&state=$d[state1]&miles=20' title='$d[address1], $d[city1], $d[state1], $d[zip1]'><img src='http://staff.mdwestserve.com/small-usps-logo.jpg' border='0'></a>Posting: $d[address1], <a title='Click to Search For Previous Contractor Rates' target='_blank' href='staff.mdwestserve.com/contractor_history.php?city=$d[city1]&zip=$d[zip1]'>$d[city1]</a>, $d[state1] <a title='Click to Search For Previous Contractor Rates' target='_blank' href='staff.mdwestserve.com/contractor_history.php?zip=$d[zip1]'>$d[zip1]</a> <b>[".getCounty($d[zip1])."]</b>".bwaRate($d[zip1]);
			}
			echo $list;
			?></td>
