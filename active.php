...
if ($list != ''){
	echo "<fieldset style='background-color:FF0000;width: 600px;'><legend>Custom Watch List</legend>$list</fieldset></td><td align='left' width='50%'>";
}?>
...
while ($i < count($servers)){
	echo "<fieldset><legend>Slot 1: ".id2name($servers["$i"])." #".$servers["$i"]."</legend>".serverActiveList($servers["$i"],'').evictionActiveList($servers["$i"])."</fieldset>";
	$i++;
}
